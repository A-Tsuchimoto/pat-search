...
J-PlatPat は、一般的な `AND OR NOT` をそのまま書くのではなく、**記号** を使います。
...
`[電池/AB+蓄電/AB]*[冷却/CL+放熱/CL]*[H01M/FI+H01M/IPC]`
...
`[キーワード群/AB または CL]*[分類群/FI または FT または IPC]`

### 例

`[全固体電池/AB+固体電解質/AB]*[H01M/FI+H01M/IPC]`
...
分類フィールドは実際に利用可能な field 名に合わせて置き換える。
...
## 14. Lens での Structured Search と手入力の使い分け
...
`("battery cooling"~5 OR "thermal management"~5) AND applicant.name:"Panasonic"`
